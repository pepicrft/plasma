...
#ifndef FBSIMULATORCONTROLKIT_SWIFT_H
#define FBSIMULATORCONTROLKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FBSimulatorControlKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)agentDidLaunch:(FBSimulatorAgentOperation * _Nonnull)operation;
- (void)agentDidTerminate:(FBSimulatorAgentOperation * _Nonnull)operation statLoc:(int32_t)statLoc;
- (void)applicationDidLaunch:(FBSimulatorApplicationOperation * _Nonnull)operation;
- (void)applicationDidTerminate:(FBSimulatorApplicationOperation * _Nonnull)operation expected:(BOOL)expected;
